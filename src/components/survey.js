...
class Survey extends Component {
	state = {
		...
		incercepts: ['-4.359',	'-4.937',	'-7.319',	'-5.154',	'-4.569',	'-6.190',	'-3.576',	'-5.277',	'-5.466',	'-4.957',	'-4.581',	'-5.181',	'-4.949',	'-5.155',	'-3.286',	'-5.155',	'-5.155',	'-5.155',	'-3.576',	'-3.576',	'-3.576',	'-5.466',	'-5.466',	'-5.466',	'-4.957',	'-4.957',	'-4.957',	'-4.581',	'-4.581',	'-4.581',	'-5.181',	'-5.181',	'-4.949',	'-4.949',	'-4.949']
};
...
//{"physique":{"physique0":"29","physique1":"222","physique2":"22"},"bleeding":{"bleeding0":false,"bleeding1":false,"bleeding2":false,"bleeding3":false,"bleeding4":false,"bleeding5":false,"bleeding6":false,"bleeding7":false},"procedures":{"procedures0":false,"procedures1":false,"procedures2":false,"procedures3":false,"procedures4":false,"procedures5":false},"diagnostic":{"diagnostic0":false,"diagnostic1":false,"diagnostic2":false,"diagnostic3":false,"diagnostic4":false},"other":{"other0":"2","other1":"Not within a year","other2":"One","other3":"No"}}
	...
	calculateBetaVector = () => {
		...
		if (this.state.metric) {
			BMI = parseFloat(this.state.responses['physique']['physique1']) / ( (parseFloat(this.state.responses['physique']['physique0']) * parseFloat(this.state.responses['physique']['physique0']) / 10000 ) )
		} else {  //not metric
			BMI = ( 703 * parseFloat(this.state.responses['physique']['physique1']) ) / ( (parseFloat(this.state.responses['physique']['physique0']) * parseFloat(this.state.responses['physique']['physique0'] ) ) )
		}
